...
import type { DeliveryLocation as _DeliveryLocation, Order as _Order, OrderStatus as _OrderStatus, Store as _Store, UserProfile as _UserProfile, UserRole as _UserRole, UserRole__1 as _UserRole__1 } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async clearDeliveryLocation(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createOrder(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: number, arg6: number): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createUserProfile(arg0: string, arg1: string, arg2: UserRole): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createUserProfile(arg0, arg1, to_candid_UserRole_n3(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDeliveryLocation(arg0: bigint): Promise<DeliveryLocation | null> {
        if (this.processError) {
            try {
    ...
    async getStoreById(arg0: bigint): Promise<Store | null> {
        if (this.processError) {
            try {
    ...
    async toggleStoreOpen(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async updateDeliveryLocation(arg0: bigint, arg1: number, arg2: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: number, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateStore(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateUserRole(arg0: Principal, arg1: UserRole): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserRole(arg0, to_candid_UserRole_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DeliveryLocation]): DeliveryLocation | null {
...
function from_candid_opt_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderStatus]): OrderStatus | null {
    return value.length === 0 ? null : from_candid_OrderStatus_n13(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Store]): Store | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "riderAssigned" in value ? OrderStatus.riderAssigned : "requested" in value ? OrderStatus.requested : "storeConfirmed" in value ? OrderStatus.storeConfirmed : "pickedUp" in value ? OrderStatus.pickedUp : "delivered" in value ? OrderStatus.delivered : value;
}
